        ...
        >
          <defs>
            ...
            <radialGradient id="cavernGoldSkyGlow" cx="48%" cy="46%" r="50%">
              <stop offset="0%" stopColor="#ffae00ff" stopOpacity="0.98" />
              <stop offset="18%" stopColor="#805700ff" stopOpacity="0.88" />
              <stop offset="42%" stopColor="#5c3a00ff" stopOpacity="0.65" />
              <stop offset="70%" stopColor="#78350f" stopOpacity="0.35" />
